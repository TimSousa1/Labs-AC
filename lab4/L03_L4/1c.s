...
addi x12, x3, 0 #x12 = a's left index # conflito de dados com o proximo addi
...
addi x11, x13, 4 #x11 = &res1 # conflito de dados com o proximo addi
...
while:
    ...
    add x19, x12, x16 #x19 = &a[i] /// conflito de dados com lw x19, 0(x19)
nop
    ...
    jal x0, while # conflito de control - fush necessario
